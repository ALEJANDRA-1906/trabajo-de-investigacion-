...
from departamentos_gll import Departamento
from empleados_gll import Empleado
from menu_gll import Helper
...
while opcion !="4":
  os.system("cls")
  opcion =helper.menu(lista, "Menú de Ficha Personal")
  os.system("cls")
  if opcion == "1":
    opc1=""
    while opc1 !=3:
    ...
    while opc1 !=3:
      ...
      if opc1 == "1":
        ...
        input("\n"
        "Su ingreso se ha realizaco con éxito // Presione una tecla cualquiera para volver al Menú")
      elif opc1 == "2":
        ...
        input("Saliendo..." 
        "\n" "Presione una tecla cualquiera para volver al Menú")
        break
  elif opcion == "4":
